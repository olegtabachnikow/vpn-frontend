...
function Options() {
  ...
  return (
    <section className='options'>
      <BackButton text='Мой VPN' currentClass='white' path={-1} />
      <div
      ...
      <div className='options__content'>
        ...
        >
          ...
          {!isActive.location ? (
            <p
              onClick={(e) => handleClick(e, { device: false, location: true })}
            ...
            <div className='options__item-content'>
              <p className='options__item-text'>
                Наша сеть серверов работает в 54 странах. Здесь мы отображаем —
                во-первых, наиболее быстрые для вас точки. Во-вторых, наиболее
                оптимальные для рф, на взгляд robo.
              </p>
        ...
        >
          ...
          {!isActive.device ? (
            <p
              onClick={(e) => handleClick(e, { location: false, device: true })}
              className='options__item-button-text'
            >
              Подробнее.
            </p>
            ...
            <div className='options__item-content'>
              <p className='options__item-text'>
                Ваш ключ подходит для всех устройств, вы можете скачать нужное
                приложение для дополнительного устройства на сайте Outline.
              </p>
              <div className='options__item-location-box'>
          ...
          <span
            className={`options__item-arrow ${isActive.device ? 'active' : ''}`}
          />
        </div>
        <div className={`options__item ${isSmartPopupOpen && 'with-popup'}`}>
          <h2 className='options__item-title'>Умный robo</h2>
          <p onClick={handleSmartPopup} className='options__item-button-text'>
            Подробнее.
          </p>
          <div
          ...
          <div
            className={`options__popup smart ${isSmartPopupOpen && 'active'}`}
          >
            <p className='options__popup-text'>
              Алгоритмы robo перераспределяют трафик в зависимости от того, на
              какой сайты вы хотите попасть. благодаря даже с включенным впн
              доступны и рф, и зарубежные сайты, где бы вы не находились.
            </p>
            <button
              onClick={handleClose}
        ...
        <div
          className={`options__item ${isCommunicatePopupOpen && 'with-popup'}`}
        >
          ...
          >
            <img
              src={isCommunicateActive ? checkboxChecked : checkboxNotChecked}
              alt='checkbox'
            />
          </div>
          <div
          ...
          >
            <p className='options__popup-text'>
              ...
              связываться с вами только в случае блокировки, чтобы предоставить
              работающий доступ к сервису. Robo напишет, что нажать в Telegram,
              если соединение можно улучшить или РКН заблокирует именно ваш
              сервер.
            </p>
      ...
      <div className='options__button-box'>
        <AppButton text='Сохранить настройки' currentClass='primary orange' />
        <AppButton
          text='Автонастройка'
